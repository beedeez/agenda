...
export declare type Processor = ((job: Job) => Promise<void>) | ((job: Job, done: (error?: Error) => void) => void);
/**
 ...
 */
export declare const define: (this: Agenda, name: string, options: DefineOptions | Processor, processor?: ((job: Job) => Promise<void>) | ((job: Job, done: (error?: Error | undefined) => void) => void) | undefined) => void;
